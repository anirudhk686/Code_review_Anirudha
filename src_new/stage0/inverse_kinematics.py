"""Functions for inverse kinematics with the MuJoCo model."""

from typing import Sequence, NamedTuple, Union, List
from typing import List, Tuple, NamedTuple, Sequence, Union, Optional
...
def name2id(physics: 'mjcf.Physics',
    ...
    """Returns list of object `ids` (indices) corresponding to `names`."""
